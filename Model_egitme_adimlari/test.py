...
all_data.columns = ['Yatay_Genlik', 'Dikey_Genlik', 'Yatay_Etiket', 'Dikey_Etiket']

# Özellikler ve etiketleri ayır
X = all_data[['Yatay_Genlik', 'Dikey_Genlik']]
y = all_data[['Yatay_Etiket', 'Dikey_Etiket']]
...
# Birinci hedef değişkeni görselleştirme (Yatay Etiket)
plt.subplot(1, 2, 1)
...
# İkinci hedef değişkeni görselleştirme (Dikey Etiket)
plt.subplot(1, 2, 2)
